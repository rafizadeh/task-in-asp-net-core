jQuery(document).ready(function($) {
  ...
  $('.dropify').dropify({
      messages: { 'default': 'Yükləmək üçün klikləyin', 'remove': '<i class="flaticon-close-fill"></i>', 'replace': 'Yükləmək üçün klikləyin', error: "" },
      error: {
          fileExtension: 'Düzgün şəkil formatı daxil edin.',
          fileSize: 'Şəklin həcmi 50 mb-dan çox ola bilməz.'
      }
  });
  ...
  $('.dropify-video').dropify({
      messages: { 'default': 'Yükləmək üçün klikləyin', 'remove': '<i class="flaticon-close-fill"></i>', 'replace': 'Yükləmək üçün klikləyin', error: "" },
      error: {
          fileExtension: 'Düzgün video formatı daxil edin.',
          fileSize: 'Videonun həcmi 3 mb-dan çox ola bilməz.'
      }
  });
